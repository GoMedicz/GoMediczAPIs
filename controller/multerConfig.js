...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    cb(null, 'images/doctors/profile'); // Set the destination folder where images will be stored
  },
...
const labReportStorage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, 'images/doctors/appointment'); // Store lab reports in the 'uploads/lab_reports' directory
  },
